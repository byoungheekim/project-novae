    ...
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section id="debut" className="px-6 py-24 sm:px-10 lg:px-16 lg:py-32">
        <div className="mx-auto max-w-7xl border-y border-border py-8 sm:py-12">
          ...
          <div className="mt-12 flex items-center justify-between border-t border-border pt-5 font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground"><span>15.12.2026 / 18:00 KST</span><a href="mailto:hello@novae.world" className="group flex items-center gap-2 text-foreground">Stay close <ArrowUpRight size={14} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" /></a></div>
        </div>
      </section>
