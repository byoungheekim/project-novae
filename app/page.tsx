    ...
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
        ...
        <div id="top" className="relative z-10 flex flex-1 flex-col justify-center py-12 lg:grid lg:grid-cols-[1fr_0.82fr] lg:items-center lg:gap-20 lg:py-0">
          <div className="max-w-3xl">
            ...
            <h1 className="font-serif text-[clamp(5rem,16vw,13.5rem)] leading-[0.76] tracking-[-0.07em] text-balance">
              We are<br /><span className="ml-[12vw] text-primary">TUIDE.</span>
            </h1>
      ...
      <section id="signal" className="border-t border-border bg-card px-6 py-24 sm:px-10 lg:px-16 lg:py-32">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-24">
          ...
          <div><p className="max-w-2xl text-2xl leading-relaxed tracking-tight text-foreground/90 sm:text-4xl">Before a star is seen, it is felt. TUIDE is the sound of that first arrival — bright, strange, and impossible to ignore.</p><div className="mt-14 flex items-center justify-between border-t border-border pt-5 font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground"><span>Transmission received</span><span className="text-primary">05 / 05 / 26</span></div></div>
        </div>
      </section>
      ...
      <section id="debut" className="px-6 py-24 sm:px-10 lg:px-16 lg:py-32">
        <div className="mx-auto max-w-7xl border-y border-border py-8 sm:py-12">
          ...
          <div className="mt-12 flex items-center justify-between border-t border-border pt-5 font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground"><span>12.15.2026 / 18:00 KST</span><a href="mailto:hello@tuide.world" className="group flex items-center gap-2 text-foreground">Stay close <ArrowUpRight size={14} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" /></a></div>
        </div>
      </section>

      <footer className="flex flex-col gap-6 border-t border-border px-6 py-7 font-mono text-[9px] uppercase tracking-[0.2em] text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-10 lg:px-16"><span>© 2026 TUIDE ENTERTAINMENT</span><span>Made for the ones who look up</span><a href="#top" className="text-primary">Back to top ↑</a></footer>
    </main>
  )
}
